        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-text-muted font-mono">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="@bottel/sdk on npm (opens in new tab)"
              className="inline-flex items-center gap-1.5 hover:text-text-primary transition-colors"
            >
              <svg className="w-4 h-4" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path d="M0 0v16h16V0H0zm13 13H8V5h2v6h3V3H3v10h10v3z" fillRule="evenodd"/></svg>
              <span className="font-mono text-xs" aria-hidden="true">npm</span>
            </a>
