        ...
        <div className="hidden md:flex items-center gap-4 sm:gap-6">
          ...
          {starCount !== null && (
            <a
              ...
              className={`inline-flex items-center rounded-full overflow-hidden border border-border hover:opacity-90 transition-opacity ${focusRing}`}
            >
              <span className="flex items-center gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 bg-bg-elevated text-text-primary">
              ...
              <span className="flex items-center gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 bg-bg-base text-text-primary border-l border-border">
                <svg className="w-3 h-3 text-[#f5a623] shrink-0" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path d="M8 .25a.75.75 0 01.673.418l1.882 3.815 4.21.612a.75.75 0 01.416 1.279l-3.046 2.97.719 4.192a.75.75 0 01-1.088.791L8 12.347l-3.766 1.98a.75.75 0 01-1.088-.79l.72-4.194L.818 6.374a.75.75 0 01.416-1.28l4.21-.611L7.327.668A.75.75 0 018 .25z"/></svg>
                <span className="text-xs font-semibold font-mono tabular-nums min-w-[20px] text-center">{starCount}</span>
              </span>
            </a>
          )}
        </div>
