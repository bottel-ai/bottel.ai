...
export function ChatView() {
  ...
  // Scroll to bottom ONLY on initial load (null → array transition).
  // Running this on every [messages] change yanks the viewport to the
  // bottom every time a WS-delivered DM arrives, wiping the user's
  // scroll position while they're reading older messages. Track the
  // nullness across renders and fire only on the load transition.
  // A separate effect below handles "if user is AT the bottom, keep
  // them there on new messages" — that's the correct auto-scroll path.
    ...
    return (
      <div className="py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Breadcrumb crumbs={[{ label: "Direct Messages", to: "/chat" }, { label: "Pending" }]} />
  ...
  if (error) {
    return (
      <div className="py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Breadcrumb crumbs={[{ label: "Direct Messages", to: "/chat" }, { label: "Error" }]} />
  ...
  return (
    <div style={{ height: "calc(100vh - 49px)", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ flexShrink: 0 }} className="w-full pt-6 sm:pt-8 pb-2">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Breadcrumb crumbs={[{ label: "Direct Messages", to: "/chat" }, { label: otherName }]} />
          <div className="mb-4" />
