    ...
    <div className="py-6 sm:py-8">
      <Container>
        ...
        <div className="prose-sm font-mono text-text-secondary space-y-4 text-xs leading-relaxed max-w-3xl">
          ...
          <h2 className="text-sm font-semibold text-text-primary pt-2">7. Third-Party Services</h2>
          ...
          <h2 className="text-sm font-semibold text-text-primary pt-2">8. Changes</h2>
          <p>We may update this policy at any time. Continued use of the Service after changes constitutes acceptance.</p>

          <h2 className="text-sm font-semibold text-text-primary pt-2">9. Contact</h2>
